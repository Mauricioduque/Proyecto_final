...
void PrimerMundo::iniciarEscenaUno()
{
    ...
    startTimer( 100 );
     ...
     //Agregamos ladrillos
    int posLadrillo[49][3] = {{400,500,2}, {526,400,2}, {650,300,2}, {900,400,1},{1100,400,1},{1240,300,2}, {1366,450,2}, {1600,520,8}, {1740,330,1}, {1920,330,1}
                             ...
                             , {5450,560,6}, {5500,510,5}, {5550,460,4}, {5600,410,3},{6000,530,1},{6100,500,1},{6200,530,1},{6400,440,1},{6500,410,1},{6600,440,1},
                              {6800,530,1},{6900,500,1},{7000,530,1},{7200,440,1},{7300,410,1},{7400,440,1},{7600,520,1},{7700,480,1},{7800,410,1},{7900,290,1},{7700,150,1}};
...
//     addItem(jabali1);
	 ...
	 //Agregamos Águilas enemigas
      aguila=new Aguila(6000,6500);
      aguila->setPos(6000,50);
      addItem(aguila);
      aguila2=new Aguila(6700,7300);
      aguila2->setPos(7300,50);
      addItem(aguila2);
      aguila3=new Aguila(7500,7950);
      aguila3->setPos(7500,50);
      addItem(aguila3);
